...
def train():
    ...
    val_dataset = HDF5VideoDataset(clip_embeddings_dir=val_hdf5_path, flow_videos_dir=flow_videos_dir, num_frames=None, max_frames=450)
    val_loader = DataLoader(val_dataset, batch_size=batch_size, shuffle=False, collate_fn=collate_fn_pad, num_workers=num_workers)
